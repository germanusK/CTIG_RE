    ...
    <div class=" my-16 h-screen flex align-middle items-center justify-center">
        ...
        <div class="flex rounded-xl shadow-2xl h-4/5 w-10/12 lg:w-8/12 mx-auto bg-black">
            ...
            <div class="w-full h-full flex items-center align-middle justify-center mx-4 lg:w-3/5 lg:mx-auto overflow-y-scroll no-scrollbar bg-white rounded-r-xl">
                <form action=" {{ url('appointments/'.$data['id'].'/payment') }} " method="POST" class="w-10/12 mx-auto rounded-lg shadow-lg px-3 py-4 bg-white">
                    @csrf
                    ...
                    <div class="py-2 mb-1 w-full px-3">
                        <span class="text-sm text-left">Name:</span><br>
                        <input class="w-full leading-relaxed h-9 text-xl px-2 border-b-2 border-black" required type="datetime-local" placeholder="schedule time" name="schedule_time">
                    </div>
                    <div class="py-4 mb-3 w-full px-3">
                        ...
                        <input class="px-5 py-3 text-lg font-bold float-right bg-black text-white rounded-md" type="submit" value="Proceed">
                    </div>
                </form>
            </div>
        </div>
