...
<body>
    <div class="top1  bg-cover bg-center w-screen min-h-screen">
        <div class=" w-full- min-h-screen bg-gradient-to-br from-green-400 to-transparent bg-opacity-600">
    ...
    <div class="sm:grid grid-cols-2 gap-4">
        ...
        <div class="h-full max-h-screen px-8">
            <img src=" {{ url('img/bg4.jpg') }} " alt="" class="rounded shadow-2xl opacity-60">
        </div>
    </div>
        </div>
    </div>
